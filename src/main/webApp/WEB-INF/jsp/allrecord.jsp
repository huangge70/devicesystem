    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="/devicesystem/deviceorder/queryRecord" class="active-menu" class="active-menu"><i class="fa fa-table"></i> 查看所有记录</a>
                </li>
            </ul>
        </div>
    </nav>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">${record.deviceNumber}</td>
                                        <td class="center"><fmt:formatDate value="${record.recordOuttime}" pattern="yyyy-MM-dd"/></td>
                                        <td class="center"><fmt:formatDate value="${record.recordIntime}" pattern="yyyy-MM-dd"/></td>
